...
import in.strikes.crudapplication.dto.ExceptionResponseDto;
import in.strikes.crudapplication.dto.ValidationExceptionResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponseDto> handleResourceNotFoundException(DuplicateResourceException ex, HttpServletRequest request){
        ExceptionResponseDto exceptionResponse = new ExceptionResponseDto(
                LocalDateTime.now(),
